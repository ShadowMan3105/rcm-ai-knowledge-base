...
REQUIRED_FILES = (
    ...
    "ops/graphify/README.md",
    "ops/graphify/run-kb-graphify.ps1",
    "ops/graphify/compose.claude-graphify-lab.yml",
    "ops/graphify/Dockerfile.graphify-runner",
    "ops/graphify/litellm-sonnet-config.yaml",
    "ops/graphify/json_guard_callback.py",
    "ops/graphify/patch_graphify_ollama_extra_body.py",
    "docs/graphify-production-operations.md",
    "docs/kb-maintenance-audit.md",
