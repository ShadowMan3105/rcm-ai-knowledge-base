...
- `_graph/incremental-latest/` is the recent-change snapshot generated by the production runner.
- The production runner is expected to run every 8 hours at 02:00, 10:00, and 18:00 local time with `ollama:qwen2.5-coder:7b`.
